<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='医护姓名' prop="yishengName">
               <el-input v-model="ruleForm.yishengName"  placeholder='医护姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='医护手机号' prop="yishengPhone">
               <el-input v-model="ruleForm.yishengPhone"  placeholder='医护手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='医护身份证号' prop="yishengIdNumber">
               <el-input v-model="ruleForm.yishengIdNumber"  placeholder='医护身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='yisheng'" label='医护头像' prop="yishengPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='坐诊时间' prop="zuozhenShijian">
               <el-input v-model="ruleForm.zuozhenShijian"  placeholder='坐诊时间' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='医护邮箱' prop="yishengEmail">
               <el-input v-model="ruleForm.yishengEmail"  placeholder='医护邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="24">
             <el-form-item v-if="flag=='yisheng'"  label="医护介绍" prop="yishengContent">
                 <editor
...
// 注册表 医护 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.zuozhenShijian)&& 'yisheng'==this.flag){
