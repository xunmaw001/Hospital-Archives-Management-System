        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yaopinZhuyiContent"  label="注意事项" prop="yaopinZhuyiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yaopinZhuyiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yaopinZhuyiContent" label="注意事项" prop="yaopinZhuyiContent">
                            <span v-html="ruleForm.yaopinZhuyiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yaopinContent"  label="药品详情" prop="yaopinContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yaopinContent" label="药品详情" prop="yaopinContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yaopinContent: [
                              { required: true, message: '药品详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.yaopinZhuyiContent = _this.ruleForm.yaopinZhuyiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        this.ruleForm.yaopinZhuyiContent = this.ruleForm.yaopinZhuyiContent.replaceAll(this.$base.url,"");
