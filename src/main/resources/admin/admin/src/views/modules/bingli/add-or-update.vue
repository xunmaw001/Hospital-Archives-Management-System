        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='yisheng'">
                    <el-form-item class="select" v-if="type!='info'"  label="医护" prop="yishengId">
                        <el-select v-model="ruleForm.yishengId" :disabled="ro.yishengId" filterable placeholder="请选择医护" @change="yishengChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="医护姓名" prop="yishengName">
                        <el-input v-model="yishengForm.yishengName"
                                  placeholder="医护姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="医护姓名" prop="yishengName">
                            <el-input v-model="ruleForm.yishengName"
                                      placeholder="医护姓名" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="医护手机号" prop="yishengPhone">
                        <el-input v-model="yishengForm.yishengPhone"
                                  placeholder="医护手机号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="医护手机号" prop="yishengPhone">
                            <el-input v-model="ruleForm.yishengPhone"
                                      placeholder="医护手机号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="医护身份证号" prop="yishengIdNumber">
                        <el-input v-model="yishengForm.yishengIdNumber"
                                  placeholder="医护身份证号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="医护身份证号" prop="yishengIdNumber">
                            <el-input v-model="ruleForm.yishengIdNumber"
                                      placeholder="医护身份证号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='yisheng' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yishengPhoto" label="医护头像" prop="yishengPhoto">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengPhoto" label="医护头像" prop="yishengPhoto">
                ...
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="坐诊时间" prop="zuozhenShijian">
                        <el-input v-model="yishengForm.zuozhenShijian"
                                  placeholder="坐诊时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="坐诊时间" prop="zuozhenShijian">
                            <el-input v-model="ruleForm.zuozhenShijian"
                                      placeholder="坐诊时间" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="医护邮箱" prop="yishengEmail">
                        <el-input v-model="yishengForm.yishengEmail"
                                  placeholder="医护邮箱" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="医护邮箱" prop="yishengEmail">
                            <el-input v-model="ruleForm.yishengEmail"
                                      placeholder="医护邮箱" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="档案编号" prop="bingliUuidNumber">
                       <el-input v-model="ruleForm.bingliUuidNumber"
                                 placeholder="档案编号" clearable  :readonly="ro.bingliUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="档案编号" prop="bingliUuidNumber">
                           <el-input v-model="ruleForm.bingliUuidNumber"
            ...
            <input id="yishengId" name="yishengId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医保信息" prop="bingliYibao">
                       <el-input v-model="ruleForm.bingliYibao"
                                 placeholder="医保信息" clearable  :readonly="ro.bingliYibao"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="医保信息" prop="bingliYibao">
                           <el-input v-model="ruleForm.bingliYibao"
                                     placeholder="医保信息" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="年龄" prop="bingliNianling">
                       <el-input v-model="ruleForm.bingliNianling"
                                 placeholder="年龄" clearable  :readonly="ro.bingliNianling"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="年龄" prop="bingliNianling">
                           <el-input v-model="ruleForm.bingliNianling"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="身体状况" prop="bingliTypes">
                        <el-select v-model="ruleForm.bingliTypes" :disabled="ro.bingliTypes" placeholder="请选择身体状况">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="身体状况" prop="bingliValue">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   bingliYibao: [
                              { required: true, message: '医保信息不能为空', trigger: 'blur' },
                          ],
                   huafeijine: [
