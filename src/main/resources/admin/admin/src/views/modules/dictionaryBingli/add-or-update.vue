<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="身体状况编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="身体状况编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="身体状况编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="身体状况编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="身体状况" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="身体状况" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="身体状况" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
        ...
        methods: {
            ...
            onSubmit() {
                if((!this.ruleForm.indexName)){
                    this.$message.error('身体状况不能为空');
                    return
                }
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        let ruleForm = this.ruleForm;
                        ruleForm["dicCode"]="bingli_types";
                        ruleForm["dicName"]="身体状况";
                        this.$http({
