    ...
    */
    ...
    public R save(@RequestBody BingliEntity bingli, HttpServletRequest request){
        ...
        Wrapper<BingliEntity> queryWrapper = new EntityWrapper<BingliEntity>()
            ...
            .eq("bingli_yibao", bingli.getBingliYibao())
            .eq("bingli_nianling", bingli.getBingliNianling())
...
//                            bingliEntity.setBingliUuidNumber(data.get(0));                    //档案编号 要改的
...
//                            bingliEntity.setBingliYibao(data.get(0));                    //医保信息 要改的
//                            bingliEntity.setHuafeijine(data.get(0));                    //花费金额 要改的
//                            bingliEntity.setXiacijiuzhenTime(sdf.parse(data.get(0)));          //下次就诊时间 要改的
//                            bingliEntity.setBingliNianling(Integer.valueOf(data.get(0)));   //年龄 要改的
//                            bingliEntity.setBingliTypes(Integer.valueOf(data.get(0)));   //身体状况 要改的
